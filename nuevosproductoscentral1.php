        <!-- =============================== NUEVOS PRODUCTOS CUERPO DE LA PAGINA ================================= -->
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">Nombre del Repuesto</a></h3>
                          <div class="rating rateit-small"> </div>
                          <div class="description"> </div>
                          <div class="product-price"> <span class="price"> S. 450.90 </span></div>
                        </div>
                        
                        <div class="cart clearfix animate-effect" align="center">
                          <div class="action" align="center">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                <button data-toggle="tooltip" class="btn btn-primary icon" type="button" title="Comprar"> <i class="fa fa-shopping-cart"></i> </button>
                      ...
                      <div class="product">
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action" align="center">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                <button data-toggle="tooltip" class="btn btn-primary icon" type="button" title="ver mas"> <i class="fa fa-shopping-cart"></i> </button>
                                <button class="btn btn-primary cart-btn" type="button">Comprar</button>
                              </li>
                            </ul>
                          </div>
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> S. 450.90 </span> <span class="price-before-discount">S. 800</span> </div>
                          <!-- /.product-price --> 
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                <button class="btn btn-primary icon" data-toggle="dropdown" type="button"> <i class="icon-shopping-cart"></i> </button>
                                <button class="btn btn-primary cart-btn" type="button">Comprar</button>
                              </li>
